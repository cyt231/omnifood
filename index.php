...
<html lang="en">
	...
	<head>
		...
		<meta name="description" content="Omnifood is a premium food delivery servive with the mission to bring affordable and healthy meals to many people as possible">
		<meta charset="utf-8">
	...
	<body>
		...
		<section class="section-testimonials">
			...
			<div class="row">
				<div class="col span-1-of-3">
					<blockquote>
						&emsp; Omnifood is just awesome! I just launched a startup which leaves me with no time for cooking, so Omnifood is a life-saver. Now that I got used to it, I couldn't live without my daily meals!
						<cite>
							<img src="resources/img/customer-1.jpg" alt="Alberto Duncan">Alberto Duncan
						</cite>
					</blockquote>
				</div>
				<div class="col span-1-of-3">
					<blockquote>
						&emsp; Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon, but no one comes even close to Omifood. Me and my family are so in love!
						<cite>
							<img src="resources/img/customer-2.jpg" alt="Joana Silva">Joana Silva
						</cite>
					</blockquote>
				</div>
				<div class="col span-1-of-3">
					<blockquote>
						&emsp; I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
						<cite>
							<img src="resources/img/customer-3.jpg" alt="Milton Chapman">Milton Chapman
						</cite>
					</blockquote>
				</div>
			</div>
		...
		<section class="section-form">
			...
			<?php
				if($_GET['success'] == 1){
					echo '<div class="row form-message success">Thank you, your message has been sent!</div>';
				}
				if($_GET['success'] == -1){
					echo '<div class="row form-message fail">Oops! Something went wrong. Please try again!</div>';
				}
			?>
				...
				<div class="form-box" id='form'>
					...
					<form action="mailer.php" method="post" class="contact-form">
						...
						<div class="row">
							...
							<div class="col span-2-of-3">
								<textarea name="drop" id="drop" placeholder='Your message'></textarea>
							</div>
						</div>
						<div class="row">
							<div class="col span-1-of-3">
		...
		<footer>
			...
			<div class="row">
				<p>Copyright &copy; 2018 by Omnifood. All right reserved</p>
			</div>
		</footer>
